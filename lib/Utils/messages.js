...
const { CALL_AUDIO_PREFIX, CALL_VIDEO_PREFIX, MEDIA_KEYS, URL_REGEX, WA_DEFAULT_EPHEMERAL } = require('../Defaults/index');
const { WAMessageStatus, WAProto } = require('../Types/index');
const { isJidGroup, isJidNewsletter, isJidStatusBroadcast, jidNormalizedUser } = require('../WABinary/index');
const { sha256 } = require('./crypto');
const { generateMessageIDV2, getKeyAuthor, unixTimestampSeconds } = require('./generics');
const { downloadContentFromMessage, encryptedStream, generateThumbnail, getAudioDuration, getAudioWaveform, getRawMediaUploadData } = require('./messages-media');
const { shouldIncludeReportingToken } = require('./reporting-utils');
const MIMETYPE_MAP = {
  image: "image/jpeg",
  video: "video/mp4",
...
const generateLinkPreviewIfRequired = async (
