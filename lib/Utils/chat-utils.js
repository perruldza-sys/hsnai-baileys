...
const { getBinaryNodeChild, getBinaryNodeChildren, isJidGroup, jidNormalizedUser } = require('../WABinary/index');
const { aesDecrypt, aesEncrypt, hmacSign } = require('./crypto');
...
const { emitSyncActionResults, processContactAction } = require('./sync-action-utils');
