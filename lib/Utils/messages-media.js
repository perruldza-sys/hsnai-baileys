...
const { createReadStream, createWriteStream, promises: fs, WriteStream } = require('fs');
const { tmpdir } = require('os');
const { join } = require('path');
const { Readable, Transform } = require('stream');
const { URL } = require('url');
const { proto } = require('../../WAProto/index');
const { DEFAULT_ORIGIN, MEDIA_HKDF_KEY_MAPPING, MEDIA_PATH_MAP } = require('../Defaults/index');
const { getBinaryNodeChild, getBinaryNodeChildBuffer, jidNormalizedUser } = require('../WABinary/index');
...
const encryptedStream = async (media, mediaType, { logger, saveOriginalFileIfRequired, opts, mediaKey: providedMediaKey } = {}) => {
