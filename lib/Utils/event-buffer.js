'use strict';
const _mod_events = require('events');
const EventEmitter = _mod_events.default !== undefined ? _mod_events.default : _mod_events;
const { WAMessageStatus } = require('../Types/index');
