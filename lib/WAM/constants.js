...
const WEB_GLOBALS = [
exports.WEB_GLOBALS = WEB_GLOBALS;
    {
        name: 'abKey2',
        id: 4473,
        type: 'string',
...
const FLAG_BYTE = 8, FLAG_GLOBAL = 0, FLAG_EVENT = 1, FLAG_FIELD = 2, FLAG_EXTENDED = 4;
exports.FLAG_BYTE = FLAG_BYTE;
