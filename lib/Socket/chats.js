...
const { DEFAULT_CACHE_TTLS, PROCESSABLE_HISTORY_TYPES } = require('../Defaults/index');
const { ALL_WA_PATCH_NAMES } = require('../Types/index');
const { SyncState } = require('../Types/State');
const { chatModificationToAppPatch, decodePatches, decodeSyncdSnapshot, encodeSyncdPatch, extractSyncdPatches, generateProfilePicture, getHistoryMsg, newLTHashState, processSyncAction } = require('../Utils/index');
const { makeMutex } = require('../Utils/make-mutex');
const _mod____Utils_process_message = require('../Utils/process-message');
const processMessage = _mod____Utils_process_message.default !== undefined ? _mod____Utils_process_message.default : _mod____Utils_process_message;
const { buildTcTokenFromJid } = require('../Utils/tc-token-utils');
const { getBinaryNodeChild, getBinaryNodeChildren, jidDecode, jidNormalizedUser, reduceBinaryNodeToDictionary, S_WHATSAPP_NET } = require('../WABinary/index');
