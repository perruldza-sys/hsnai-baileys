'use strict';
const _mod__cacheable_node_cache = require('@cacheable/node-cache');
const NodeCache = _mod__cacheable_node_cache.default !== undefined ? _mod__cacheable_node_cache.default : _mod__cacheable_node_cache;
const { Boom } = require('@hapi/boom');
const { proto } = require('../../WAProto/index');
const { DEFAULT_CACHE_TTLS, WA_DEFAULT_EPHEMERAL } = require('../Defaults/index');
const { aggregateMessageKeysNotFromMe, assertMediaContent, bindWaitForEvent, decryptMediaRetryData, encodeNewsletterMessage, encodeSignedDeviceIdentity, encodeWAMessage, encryptMediaRetryRequest, extractDeviceJids, generateMessageIDV2, generateParticipantHashV2, generateWAMessage, generateWAMessageFromContent, getStatusCodeForMediaRetry, getUrlFromDirectPath, getWAUploadToServer, MessageRetryManager, normalizeMessageContent, prepareWAMessageMedia, parseAndInjectE2ESessions, unixTimestampSeconds } = require('../Utils/index');
const { generateTableContent, generateTableContentV2, generateListContent, generateCodeBlockContent, generateCodeBlockContentV2, generateLinkContent, generateLinkContentV2, generateRichMessageContent, generateLatexContent, generateLatexImageContent, generateLatexInlineImageContent, generateUnifiedResponseContent, captureUnifiedResponse } = require('../Utils/rich-messages');
...
const { areJidsSameUser, getAdditionalNode, getBinaryNodeChild, getBinaryNodeChildren, isHostedLidUser, isHostedPnUser, isJidGroup, isJidNewsletter, isLidUser, isPnUser, jidDecode, jidEncode, jidNormalizedUser, S_WHATSAPP_NET } = require('../WABinary/index');
const { USyncQuery, USyncUser } = require('../WAUSync/index');
const { Dugong } = require('./dugong');
