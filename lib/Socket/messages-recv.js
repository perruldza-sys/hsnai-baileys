...
const _mod_long = require('long');
const Long = _mod_long.default !== undefined ? _mod_long.default : _mod_long;
const { proto } = require('../../WAProto/index');
const { DEFAULT_CACHE_TTLS, KEY_BUNDLE_TYPE, MIN_PREKEY_COUNT, PLACEHOLDER_MAX_AGE_SECONDS, STATUS_EXPIRY_SECONDS } = require('../Defaults/index');
const { WAMessageStatus, WAMessageStubType } = require('../Types/index');
const { aesDecryptCTR, aesEncryptGCM, cleanMessage, Curve, decodeMediaRetryNode, decodeMessageNode, decryptMessageNode, delay, derivePairingCodeKey, encodeBigEndian, encodeSignedDeviceIdentity, extractAddressingContext, getCallStatusFromNode, getHistoryMsg, getNextPreKeys, getStatusFromReceiptType, handleIdentityChange, hkdf, MISSING_KEYS_ERROR_TEXT, NACK_REASONS, NO_MESSAGE_FOUND_ERROR_TEXT, toNumber, unixTimestampSeconds, xmppPreKey, xmppSignedPreKey } = require('../Utils/index');
const { makeMutex } = require('../Utils/make-mutex');
const { makeOfflineNodeProcessor } = require('../Utils/offline-node-processor');
const { buildAckStanza } = require('../Utils/stanza-ack');
const { areJidsSameUser, binaryNodeToString, getAllBinaryNodeChildren, getBinaryNodeChild, getBinaryNodeChildBuffer, getBinaryNodeChildren, getBinaryNodeChildString, isJidGroup, isJidNewsletter, isJidStatusBroadcast, isLidUser, isPnUser, jidDecode, jidNormalizedUser, S_WHATSAPP_NET } = require('../WABinary/index');
