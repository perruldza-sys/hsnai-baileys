'use strict';
const _mod_crypto = require('crypto');
const crypto = _mod_crypto.default !== undefined ? _mod_crypto.default : _mod_crypto;
const { proto } = require('../../WAProto/index');
const { delay, generateMessageID, generateWAMessage, generateWAMessageContent, generateWAMessageFromContent, getUrlFromDirectPath, normalizeMessageContent, prepareWAMessageMedia } = require('../Utils/index');
const { isJidGroup, isPnUser, jidNormalizedUser, STORIES_JID } = require('../WABinary/index');
class Dugong {
exports.Dugong = Dugong;
